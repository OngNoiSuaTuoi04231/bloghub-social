...
export default function CreatePost() {
  ...
  const handlePost = async () => {
    // Sửa lỗi kẹt nút đăng bài: dùng .trim() để xử lý các khoảng trắng thừa
    ...
    if (mediaFile) {
      // Đã sửa thành "image" để khớp hoàn toàn với Backend multer của nhóm
    ...
    try {
      ...
      if (data.success) {
        ...
        setContent("");
        removeMedia();
        navigate("/"); // Chuyển về trang chủ sau khi đăng thành công
      } else {
