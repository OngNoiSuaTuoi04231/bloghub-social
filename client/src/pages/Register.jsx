...
function LeftPanel({ dark }) {
  return (
    ...
    >
      <div className={`absolute -top-16 -left-16 w-60 h-60 rounded-full ${dark ? "bg-violet-500/10" : "bg-white/10"}`} />
      <div className={`absolute -bottom-12 -right-12 w-52 h-52 rounded-full ${dark ? "bg-purple-400/10" : "bg-white/10"}`} />
      <div className={`absolute top-1/3 right-0 w-32 h-32 rounded-full ${dark ? "bg-indigo-400/5" : "bg-white/5"}`} />
      ...
      <div className="relative z-10 flex flex-col items-center text-center w-full">
        ...
        >
          <svg viewBox="0 0 64 64" className="w-12 h-12 lg:w-14 lg:h-14" fill="none">
            <path d="M10 14 C10 14 20 16 32 16 C44 16 54 14 54 14 L54 50 C54 50 44 48 32 48 C20 48 10 50 10 50 Z" fill="white" fillOpacity={dark ? "0.08" : "0.15"} stroke="white" strokeWidth="1.5" />
        ...
        >
          ...
          <div className="flex items-center gap-2.5 mt-3">
            <div className={`w-7 h-7 rounded-full flex items-center justify-center text-white text-[10px] font-bold flex-shrink-0 ${dark ? "bg-violet-500/40" : "bg-white/30"}`}>
              TH
            </div>
    ...
    >
      ...
      >
        ...
        >
          ...
          <p className={`text-center md:text-center transition-colors duration-300 ${dark ? "text-violet-400" : "text-gray-400"}`}>
          ...
          <form onSubmit={handleRegister} className="flex flex-col gap-[14px]" autoComplete="off">
            ...
            <label className="flex items-start gap-2.5 cursor-pointer mt-0.5">
              ...
              <span className={`text-[12.5px] leading-relaxed pt-0.5 transition-colors duration-300 ${dark ? "text-violet-400" : "text-gray-500"}`}>
                I agree to the{" "}
                <span className={`font-semibold hover:underline cursor-pointer ${dark ? "text-violet-300" : "text-indigo-500"}`}>
                  Terms of Service
                </span>{" "}
                and{" "}
                <span className={`font-semibold hover:underline cursor-pointer ${dark ? "text-violet-300" : "text-indigo-500"}`}>
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className={`text-[11px] font-semibold tracking-[0.12em] uppercase transition-colors duration-300 ${dark ? "text-violet-700" : "text-gray-400"}`}>
              Or join with
            </span>
            <div className={`flex-1 h-px transition-colors duration-300 ${dark ? "bg-violet-900" : "bg-gray-100"}`} />
          </div>
